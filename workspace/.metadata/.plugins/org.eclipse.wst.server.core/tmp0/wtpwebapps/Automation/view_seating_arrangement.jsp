				...
				<div class="columns ">
						...
						<li >
								...
								<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">View Seating Arrangement</h4>
        			...
        			<div id="customerGrid">
                        ...
                        <div class="grid">
						   ...
						   SeatingArangementTO ex = (SeatingArangementTO) iter.next();
						   
						  
						   %>
                                <tr id="" >
                                        <td ><%=ex.getFromroll()%></td>
                                        <td class=" "><%=ex.getToroll()%></td>
										<td class=" "><%=ex.getClsroomno()%></td>
                                   </tr>
								    <%}}%>
								</tbody>
								</table>
