...
<td>
<form action="InvigilatorLoginAction" method="post">
<div class="login-block">
    <h1>Invigilator Login</h1>
    <input type="text" value="" name="invgname" placeholder="Username" id="username" />
    <input type="password" value=""  name="invgpass" placeholder="Password" id="password" />
