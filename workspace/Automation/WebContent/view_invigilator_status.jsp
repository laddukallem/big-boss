				...
				<div class="columns ">
						...
						<li >
								...
								<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">view Status</h4>
        			...
        			<div id="customerGrid">
                        ...
                        <div class="grid">
						   ...
						   InvigilatorTO ex = (InvigilatorTO) iter.next();
						   
						  
						   %>
                                <tr id="" >
                                        <td ><%=ex.getInvgname()%></td>
                                        <td class=" "><%=ex.getInvgcls()%></td>
										<td class=" "><%=ex.getTime()%></td>
                                   </tr>
								    <%}}%>
								</tbody>
								</table>
