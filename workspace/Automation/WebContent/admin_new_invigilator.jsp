						...
						<li >
								...
								<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">New invigilator</h4>
                                        ...
                                        <fieldset id="group_fields4">
											...
											<form action="InvigilatorAction" method="post">
                                                <table cellspacing="0" class="form-list">
                                                <tbody>
									
													<tr class="hidden">
                                                      <td class="label"><label >Invigilator ID</label></td>
													  <td class="value">
                                                        	<input id="" name="invgid" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
                                                      <td class="label"><label >Class room</label></td>
													  <td class="value">
                                                        	<input id="" name="invgcls" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
													  ...
													  <td class="value">
                                                        	<input id="" name="time" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
                                                      <td class="label"><label >Invigilator Name</label></td>
													  <td class="value">
                                                        	<input id="" name="invgname" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
													  ...
													  <td class="value">
                                                        	<input id="" name="invgpass" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
