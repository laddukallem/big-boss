...
<span style="font-size:30px;color:#EC6E07;padding-top:20px;">Automation Of Examination System</span>
								...
								<tr>
								<td width="50%">
								<img border="0" alt="AOES" src="img/ExamBuilder.jpg" width="400" height="350" align="right">
								</td>
								<td width="50%">
								 <p style="font-size:40px;color:#CF2118;padding-top:20px;margin-left:60px;line-height:50px;">Admin Control Panel</p>
								</td>
								</tr>
								</table>
