						...
						<li >
								...
								<div class="entry-edit">
                                        <div class="entry-edit-head">
                                            <h4 class="icon-head head-edit-form fieldset-legend">Examination Schedule </h4>
                                        ...
                                        <fieldset id="group_fields4">
											...
											<form action="ExaminationSchAction" method="post">
                                                ...
                                                <tbody>
													...
													<tr class="hidden">
													  ...
													  <td class="value">
                                                        	<input id="" name="subject" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
													  ...
													  <td class="value">
                                                        	<input id="" name="date" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
													<tr class="hidden">
                                                      <td class="label"><label >Duration</label></td>
													  <td class="value">
                                                        	<input id="" name="duration" value="" class=" input-text" type="text"/>
                                                        </td>
                                                        <td><small></small></td>
                                                    </tr>
