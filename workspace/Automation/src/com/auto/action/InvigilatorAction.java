...
public class InvigilatorAction extends HttpServlet {
...
try {
	...
	flag = new AutomationDelegate().insertInvigilator(iv);

	if (flag) {

		path = "./admin_new_invigilator.jsp";
		...
		request.setAttribute("status200", " invigilator is Failed");
	}
