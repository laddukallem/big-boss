...
public class ViewInvgExamnationSch extends HttpServlet {
...
try {
	...
	list =new AutomationDelegate().viewExaminationList(ex);
	
	

	if (!list.isEmpty()) {

		path = "./view_invigilator_schedule.jsp";
